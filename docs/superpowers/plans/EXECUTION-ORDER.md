...
- [x] plan-04 附件系统 ✅
- [x] plan-05 收发补全（CC/BCC/转发/草稿/签名）✅
...
- [x] plan-07 全文搜索（FTS5）✅
- [x] plan-08 组织整理（标签/会话/批量/Snooze/转待办）✅
- [x] plan-09 联系人通讯录✅
- [x] plan-10 规则与过滤器✅
- [x] plan-11 安全（收敛版）✅
...
- [x] plan-12 AI 增强 + LLM 配置中心 ✅
- [x] plan-13 定时/撤销发送 + 模板 ✅
- [x] plan-14 效率与体验（游标分页/暗色主题/快捷键）✅
- [x] plan-15 设置中心统一化（签名多套/导入导出）✅
- [x] plan-16 日历与日程（events 表/月视图/邮件转日程）✅
